...
/* harmony import */ var _highlight_replacement_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../highlight_replacement.js */ "./src/highlight_replacement.js");
/* harmony import */ var C_Users_shark_Documents_re_search_node_modules_svelte_loader_lib_hot_api_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/svelte-loader/lib/hot-api.js */ "./node_modules/svelte-loader/lib/hot-api.js");
/* harmony import */ var C_Users_shark_Documents_re_search_node_modules_svelte_hmr_runtime_proxy_adapter_dom_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./node_modules/svelte-hmr/runtime/proxy-adapter-dom.js */ "./node_modules/svelte-hmr/runtime/proxy-adapter-dom.js");
/* module decorator */ module = __webpack_require__.hmd(module);
/* src\popup\pager.svelte generated by Svelte v4.2.0 */
...
const file = "src\\popup\\pager.svelte";

function add_css(target) {
	(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append_styles)(target, "svelte-lxwttd", "body.svelte-lxwttd{display:flex;flex-direction:column}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}

// (36:8) {:else}
function create_else_block_1(ctx) {
	const block = { c: svelte_internal__WEBPACK_IMPORTED_MODULE_0__.noop, m: svelte_internal__WEBPACK_IMPORTED_MODULE_0__.noop, d: svelte_internal__WEBPACK_IMPORTED_MODULE_0__.noop };
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.text)(/*currentMatch*/ ctx[0]);
			t2 = (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.text)(" of ");
			t3 = (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.text)(/*maxMatches*/ ctx[1]);
			t4 = (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.text)(" matches.");
		},
		...
		p: function update(ctx, dirty) {
			if (dirty & /*currentMatch*/ 1) (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.set_data_dev)(t1, /*currentMatch*/ ctx[0]);
			if (dirty & /*maxMatches*/ 2) (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.set_data_dev)(t3, /*maxMatches*/ ctx[1]);
		},
		d: function destroy(detaching) {
			if (detaching) {
				...
				(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.detach_dev)(t4);
			}
		}
	};
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			t0 = (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.text)("Showing ");
			t1 = (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.text)(/*currentMatch*/ ctx[0]);
			t2 = (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.text)(" of 1 match.");
		},
		m: function mount(target, anchor) {
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.insert_dev)(target, t0, anchor);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.insert_dev)(target, t1, anchor);
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(br, file, 40, 8, 872);
		},
		m: function mount(target, anchor) {
		...
		d: function destroy(detaching) {
			if (detaching) {
				(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.detach_dev)(br);
			}
		}
	};
...
function create_fragment(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*matchInfo*/ ctx[2]) return create_if_block_2;
	...
	function select_block_type_1(ctx, dirty) {
		if (/*maxMatches*/ ctx[1] < 0) return create_if_block;
		if (/*maxMatches*/ ctx[1] == 1) return create_if_block_1;
	...
	const block = {
		c: function create() {
			...
			if_block1.c();
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(div0, "id", "match-display");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(div0, file, 32, 4, 709);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(div1, "id", "match-counter");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(div1, file, 38, 4, 812);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(body, "class", "svelte-lxwttd");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(body, file, 31, 0, 697);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		m: function mount(target, anchor) {
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.insert_dev)(target, body, anchor);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append_dev)(body, div0);
			if_block0.m(div0, null);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append_dev)(body, t);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append_dev)(body, div1);
		...
		d: function destroy(detaching) {
			if (detaching) {
				(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.detach_dev)(body);
			}
...
function instance($$self, $$props, $$invalidate) {
	...
	(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.validate_slots)('Pager', slots, []);
	let { currentMatch = -1 } = $$props;
	let { maxMatches = -1 } = $$props;
	let { matchInfo = null } = $$props;

	function GetAggregatedText() {
		if (matchInfo) {
			let intermediate = "";

			for (let child of matchInfo.wrapper.children) {
				intermediate += child.textContent;
			}
	...
	const writable_props = ['currentMatch', 'maxMatches', 'matchInfo'];
	...
	$$self.$$set = $$props => {
		if ('currentMatch' in $$props) $$invalidate(0, currentMatch = $$props.currentMatch);
		if ('maxMatches' in $$props) $$invalidate(1, maxMatches = $$props.maxMatches);
		if ('matchInfo' in $$props) $$invalidate(2, matchInfo = $$props.matchInfo);
	};

	$$self.$capture_state = () => ({
		HighlightReplacement: _highlight_replacement_js__WEBPACK_IMPORTED_MODULE_2__.HighlightReplacement,
		currentMatch,
		maxMatches,
		matchInfo,
		GetAggregatedText
	...
	return [currentMatch, maxMatches, matchInfo];
}

class Pager extends svelte_internal__WEBPACK_IMPORTED_MODULE_0__.SvelteComponentDev {
	constructor(options) {
		super(options);
...
(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.create_custom_element)(Pager, {"currentMatch":{},"maxMatches":{},"matchInfo":{}}, [], [], true);
...
/* harmony import */ var svelte_internal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! svelte/internal */ "./node_modules/svelte/src/runtime/internal/index.js");
/* harmony import */ var svelte_internal_disclose_version__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! svelte/internal/disclose-version */ "./node_modules/svelte/src/runtime/internal/disclose-version/index.js");
/* harmony import */ var _searchinput_svelte__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./searchinput.svelte */ "./src/popup/searchinput.svelte");
/* harmony import */ var _pager_svelte__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pager.svelte */ "./src/popup/pager.svelte");
/* harmony import */ var _message_protocol_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../message_protocol.js */ "./src/message_protocol.js");
/* harmony import */ var _highlight_replacement_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../highlight_replacement.js */ "./src/highlight_replacement.js");
/* harmony import */ var C_Users_shark_Documents_re_search_node_modules_svelte_loader_lib_hot_api_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./node_modules/svelte-loader/lib/hot-api.js */ "./node_modules/svelte-loader/lib/hot-api.js");
/* harmony import */ var C_Users_shark_Documents_re_search_node_modules_svelte_hmr_runtime_proxy_adapter_dom_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./node_modules/svelte-hmr/runtime/proxy-adapter-dom.js */ "./node_modules/svelte-hmr/runtime/proxy-adapter-dom.js");
/* module decorator */ module = __webpack_require__.hmd(module);
/* src\popup\popup.svelte generated by Svelte v4.2.0 */
...
function add_css(target) {
	(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append_styles)(target, "svelte-lxwttd", "body.svelte-lxwttd{display:flex;flex-direction:column}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function create_fragment(ctx) {
	...
	let t2;
	let pager;
	let updating_maxMatches;
	let updating_currentMatch;
	let updating_matchInfo;
	let current;
	searchinput = new _searchinput_svelte__WEBPACK_IMPORTED_MODULE_2__["default"]({ $$inline: true });

	function pager_maxMatches_binding(value) {
		/*pager_maxMatches_binding*/ ctx[3](value);
	}

	function pager_currentMatch_binding(value) {
		/*pager_currentMatch_binding*/ ctx[4](value);
	}

	function pager_matchInfo_binding(value) {
		/*pager_matchInfo_binding*/ ctx[5](value);
	}

	let pager_props = {};

	if (/*maxMatches*/ ctx[0] !== void 0) {
		pager_props.maxMatches = /*maxMatches*/ ctx[0];
	}

	if (/*currentMatch*/ ctx[1] !== void 0) {
		pager_props.currentMatch = /*currentMatch*/ ctx[1];
	}

	if (/*matchInfo*/ ctx[2] !== void 0) {
		pager_props.matchInfo = /*matchInfo*/ ctx[2];
	}

	pager = new _pager_svelte__WEBPACK_IMPORTED_MODULE_3__["default"]({ props: pager_props, $$inline: true });
	svelte_internal__WEBPACK_IMPORTED_MODULE_0__.binding_callbacks.push(() => (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.bind)(pager, 'maxMatches', pager_maxMatches_binding));
	svelte_internal__WEBPACK_IMPORTED_MODULE_0__.binding_callbacks.push(() => (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.bind)(pager, 'currentMatch', pager_currentMatch_binding));
	svelte_internal__WEBPACK_IMPORTED_MODULE_0__.binding_callbacks.push(() => (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.bind)(pager, 'matchInfo', pager_matchInfo_binding));
	...
	const block = {
		c: function create() {
			...
			body = (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.element)("body");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.create_component)(searchinput.$$.fragment);
			t2 = (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.space)();
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.create_component)(pager.$$.fragment);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(h4, file, 36, 0, 979);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(body, "class", "svelte-lxwttd");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(body, file, 37, 0, 996);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		m: function mount(target, anchor) {
			...
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.insert_dev)(target, t1, anchor);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.insert_dev)(target, body, anchor);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.mount_component)(searchinput, body, null);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append_dev)(body, t2);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.mount_component)(pager, body, null);
			current = true;
		},
		p: function update(ctx, [dirty]) {
			const pager_changes = {};

			if (!updating_maxMatches && dirty & /*maxMatches*/ 1) {
				updating_maxMatches = true;
				pager_changes.maxMatches = /*maxMatches*/ ctx[0];
				(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_flush_callback)(() => updating_maxMatches = false);
			}

			if (!updating_currentMatch && dirty & /*currentMatch*/ 2) {
				updating_currentMatch = true;
				pager_changes.currentMatch = /*currentMatch*/ ctx[1];
				(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_flush_callback)(() => updating_currentMatch = false);
			}

			if (!updating_matchInfo && dirty & /*matchInfo*/ 4) {
				updating_matchInfo = true;
				pager_changes.matchInfo = /*matchInfo*/ ctx[2];
				(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_flush_callback)(() => updating_matchInfo = false);
			}
		...
		i: function intro(local) {
			if (current) return;
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.transition_in)(searchinput.$$.fragment, local);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.transition_in)(pager.$$.fragment, local);
			current = true;
		},
		o: function outro(local) {
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.transition_out)(searchinput.$$.fragment, local);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.transition_out)(pager.$$.fragment, local);
			current = false;
		},
		d: function destroy(detaching) {
			if (detaching) {
				(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.detach_dev)(h4);
				(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.detach_dev)(t1);
				(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.detach_dev)(body);
			}

			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.destroy_component)(searchinput);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.destroy_component)(pager);
		}
	};
...
function instance($$self, $$props, $$invalidate) {
	let { $$slots: slots = {}, $$scope } = $$props;
	(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.validate_slots)('Extension-Popup', slots, []);
	let maxMatches = -1;
	let currentMatch = -1;
	...
	function MessageListener(message) {
		switch (message.command) {
			case _message_protocol_js__WEBPACK_IMPORTED_MODULE_4__.MessageType.SENT_NUM:
				$$invalidate(1, currentMatch = message.params[0] ? message.params : -1);
				$$invalidate(2, matchInfo = message.params[1]);
				break;
			case _message_protocol_js__WEBPACK_IMPORTED_MODULE_4__.MessageType.SENT_MAX:
				$$invalidate(0, maxMatches = message.params[0]);
				break;
		}
	}
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Extension-Popup> was created with unknown prop '${key}'`);
	});

	function pager_maxMatches_binding(value) {
		maxMatches = value;
		$$invalidate(0, maxMatches);
	}

	function pager_currentMatch_binding(value) {
		currentMatch = value;
		$$invalidate(1, currentMatch);
	}

	function pager_matchInfo_binding(value) {
		matchInfo = value;
		$$invalidate(2, matchInfo);
	}

	$$self.$capture_state = () => ({
		SearchInput: _searchinput_svelte__WEBPACK_IMPORTED_MODULE_2__["default"],
		Pager: _pager_svelte__WEBPACK_IMPORTED_MODULE_3__["default"],
		Message: _message_protocol_js__WEBPACK_IMPORTED_MODULE_4__.Message,
		MessageType: _message_protocol_js__WEBPACK_IMPORTED_MODULE_4__.MessageType,
		HighlightReplacement: _highlight_replacement_js__WEBPACK_IMPORTED_MODULE_5__.HighlightReplacement,
		maxMatches,
		currentMatch,
		matchInfo,
		MessageListener
	...
	$$self.$inject_state = $$props => {
		if ('maxMatches' in $$props) $$invalidate(0, maxMatches = $$props.maxMatches);
		if ('currentMatch' in $$props) $$invalidate(1, currentMatch = $$props.currentMatch);
		if ('matchInfo' in $$props) $$invalidate(2, matchInfo = $$props.matchInfo);
	};
	...
	return [
		...
		currentMatch,
		matchInfo,
		pager_maxMatches_binding,
		pager_currentMatch_binding,
		pager_matchInfo_binding
	];
}
...
customElements.define("Extension-Popup", (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.create_custom_element)(Popup, {}, [], [], true));
if (module && module.hot) {}
...
/* harmony import */ var svelte_internal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! svelte/internal */ "./node_modules/svelte/src/runtime/internal/index.js");
/* harmony import */ var svelte_internal_disclose_version__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! svelte/internal/disclose-version */ "./node_modules/svelte/src/runtime/internal/disclose-version/index.js");
/* harmony import */ var _message_protocol_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../message_protocol.js */ "./src/message_protocol.js");
/* harmony import */ var C_Users_shark_Documents_re_search_node_modules_svelte_loader_lib_hot_api_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/svelte-loader/lib/hot-api.js */ "./node_modules/svelte-loader/lib/hot-api.js");
/* harmony import */ var C_Users_shark_Documents_re_search_node_modules_svelte_hmr_runtime_proxy_adapter_dom_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./node_modules/svelte-hmr/runtime/proxy-adapter-dom.js */ "./node_modules/svelte-hmr/runtime/proxy-adapter-dom.js");
/* module decorator */ module = __webpack_require__.hmd(module);
/* src\popup\searchinput.svelte generated by Svelte v4.2.0 */


const { console: console_1 } = svelte_internal__WEBPACK_IMPORTED_MODULE_0__.globals;


const file = "src\\popup\\searchinput.svelte";

function add_css(target) {
	(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append_styles)(target, "svelte-1e40vz4", "div.svelte-1e40vz4{display:flex;flex-direction:row}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(input, file, 38, 4, 956);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(button, file, 39, 4, 1034);
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr_dev)(div, "class", "svelte-1e40vz4");
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.add_location)(div, file, 37, 0, 945);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		m: function mount(target, anchor) {
			...
			(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.set_input_value)(input, /*searchstring*/ ctx[0]);
			...
			if (!mounted) {
				dispose = [
					...
					(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.listen_dev)(input, "keydown", /*EnterListener*/ ctx[2], false, false, false, false),
					(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.listen_dev)(button, "click", /*SearchClickHandler*/ ctx[1], false, false, false, false)
				];
...
function instance($$self, $$props, $$invalidate) {
	let { $$slots: slots = {}, $$scope } = $$props;
	(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.validate_slots)('search-input', slots, []);
	let { searchstring = "" } = $$props;

	function SendSearchString(seString, tabList) {
		let msgObj = new _message_protocol_js__WEBPACK_IMPORTED_MODULE_2__.Message(_message_protocol_js__WEBPACK_IMPORTED_MODULE_2__.MessageType.SEARCH, [seString]);
		browser.tabs.sendMessage(tabList[0].id, msgObj).catch(ErrorReport);
	}

	function SearchClickHandler(event) {
		browser.tabs.query({ active: true, currentWindow: true }).then(SendSearchString.bind(null, searchstring)).catch(ErrorReport);
	}

	function EnterListener(event) {
		if (event.key == "Enter") SearchClickHandler(event); else return;
	}

	const writable_props = ['searchstring'];

	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<search-input> was created with unknown prop '${key}'`);
	});
	...
	$$self.$capture_state = () => ({
		MessageType: _message_protocol_js__WEBPACK_IMPORTED_MODULE_2__.MessageType,
		Message: _message_protocol_js__WEBPACK_IMPORTED_MODULE_2__.Message,
		searchstring,
		ErrorReport,
		SendSearchString,
		SearchClickHandler,
	...
	return [searchstring, SearchClickHandler, EnterListener, input_input_handler];
}

class Searchinput extends svelte_internal__WEBPACK_IMPORTED_MODULE_0__.SvelteComponentDev {
	constructor(options) {
		super(options);
		(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.init)(this, options, instance, create_fragment, svelte_internal__WEBPACK_IMPORTED_MODULE_0__.safe_not_equal, { searchstring: 0 }, add_css);
...
customElements.define("search-input", (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.create_custom_element)(Searchinput, {"searchstring":{}}, [], [], true));
if (module && module.hot) {}
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/popup/popup.svelte");
/******/ 	
/******/ })()
;
